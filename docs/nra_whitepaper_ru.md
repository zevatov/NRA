...
![Storage Comparison](assets/storage_comparison_ru.png)
...
![FPS Comparison](assets/fps_comparison_ru.png)
...
![Cold Start Comparison](assets/cold_start_comparison_ru.png)
...
![Random Access Penalty](assets/random_access_penalty_ru.png)
...
![Live Training Loss Vision](assets/training_loss_vision_ru.png)
...
![Live Training Loss Text](assets/training_loss_text_ru.png)
...
![Live Training Loss Multi](assets/training_loss_multi_ru.png)
...
Благодаря этой архитектуре, вы можете запустить обучение **одной строчкой кода**. Любой желающий может прямо сейчас скопировать этот код и протестировать стриминг на нашем официальном демо-датасете (Food-101 на 5 ГБ):
