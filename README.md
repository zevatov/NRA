<div align="center">
  ...
  **🌐 Language / Язык: [English](README.md) | [Русский](README_RU.md)**
  ...
  [![PyPI - Version](https://img.shields.io/badge/latest-1.0.2-brightgreen)](https://pypi.org/project/nra/1.0.2/)
...
1. **Python SDK ([`pip install nra==1.0.2`](https://pypi.org/project/nra/1.0.2/)):** Integration into PyTorch and TensorFlow.
